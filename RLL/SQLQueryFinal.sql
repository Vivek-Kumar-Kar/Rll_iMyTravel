...
CREATE TABLE [dbo].[UserLogin](
	[UserLoginId] [int] IDENTITY(10,1) NOT NULL,
	[Password] [nvarchar](20) NOT NULL,
...
alter table Cities add Cost float
  alter table Cities add Description varchar(max)


  Delete from Feedback Where UserId='anu123';